...
export function DashboardPage() {
  ...
  return <main className="app-shell dashboard-page dashboard-page--visual" aria-busy={loading}><VisualDashboard hasNewPr={hasNewPr} markingWorkout={markingWorkout} onAdd={() => openQuickAddPersonalRecord()} onMarkWorkout={() => { void markTodayWorkout() }} onRemoveWorkout={(date) => { void removeCompletedWorkout(date) }} progresses={progresses} streak={getStreak(trainingDates)} trainingDates={trainingDates} trainingDays={trainingDates.length} workoutCompleted={trainingDates.includes(todayDate())} /></main>
}
